...
const MOD_KEY: StringName = &"steam_curator_tycoon"
...
## Used in Bot to take advantage of rand_weighted
static var rng := RandomNumberGenerator.new()

## A global reference to your mod. Its type must match the class_name (line 1)
static var instance: SteamCuratorsMod
...
func _ready() -> void:
	...
	edit_save_data(MOD_KEY, get_save_data())
...
func _on_mods_loaded() -> void:
	...
	Clock.instance.hour = hour
	Clock.instance.day_passed.connect(increment_day)
	Clock.instance.hour_passed.connect(sync_hour)
...
func set_day(new_day: int) -> void:
	...
	day = new_day
	Curator1.instance.update_day_label()
...
func get_save_data() -> Dictionary:
	return {
		"me": self, # Saves and loads `day` automatically
		"curator accounts": CuratorAccount.instance,
	}
...
func sync_hour() -> void:
	...
	Curator1.instance.update_hour_label()
